...
def predict_test(input_file,out_file):
    entities=[]
...
if __name__ =='__main__':
    ...
    parser.add_argument("--data_path", type=str, default='../datasets/traindata-details-v3.json')
    ...
    parser.add_argument("--err_file", type=str, default='../datasets/2error')
    ...
    predict_test(hparams.input_file,hparams.output_file)
    error_de(hparams.err_file+'.txt')
    # for i in range(10):
    #     data_split(hparams.data_path, hparams.data_split_path)
    #     predict_test(hparams.input_file,hparams.output_file)
    #     error_de(hparams.err_file+str(i)+'.txt')
