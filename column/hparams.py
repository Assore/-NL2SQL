...
default_train_file = os.path.join(here, '../datasets/train.json')
default_validation_file = os.path.join(here, '../datasets/val.json')
default_test_file = os.path.join(here, '../datasets/test.json')
default_output_dir = os.path.join(here, '../saved_models/column')
default_log_dir = os.path.join(default_output_dir, 'runs')
default_tagset_file = os.path.join(here, '../datasets/columns.txt')
