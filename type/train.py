...
from type.data_utils import SentenceREDataset, get_idx2tag, load_checkpoint, save_checkpoint
...
def train(hparams,BT,BM):
    ...
    if test_file:
        ...
        with torch.no_grad():
            ...
            recall = metrics.recall_score(tags_true, tags_pred, average='weighted')
            accuracy = metrics.accuracy_score(tags_true, tags_pred)
            print("type_test recall:",recall)
            print("type_test precision:",precision)
            print("type_test f1:",f1)
